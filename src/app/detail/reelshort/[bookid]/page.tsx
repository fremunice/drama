...
async function fetchReelShortDetail(bookId: string): Promise<ReelShortDetailData> {
  ...
  // API returns { code, data: {...}, msg } - extract the data object
            ...
            <div className="space-y-6">
              ...
              <div className="glass rounded-xl p-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {((data.description || "").startsWith("http") || (data.description || "").includes(".m3u8") || (data.description || "").includes(".mp4") ? "Tidak ada deskripsi." : (data.description || "Tidak ada deskripsi."))}
                </p>
              </div>
