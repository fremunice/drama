...
export default function GoodShortDetailPage() {
  ...
  const coverUrl = book.cover || book.posterImg || "";
  const totalEpisodes = book.episodes?.length || book.totalEpisodes || 0;
            ...
            <div className="space-y-6">
              <div>
                ...
                {book.categoryNames && book.categoryNames.length > 0 && (
                  <div className="flex flex-wrap gap-2 mt-4">
                    {book.categoryNames.map((label: string, idx: number) => (
              ...
              <div className="glass rounded-xl p-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {((book.description || "").startsWith("http") || (book.description || "").includes(".m3u8") || (book.description || "").includes(".mp4") ? "Tidak ada sinopsis." : (book.description || "Tidak ada sinopsis."))}
                </p>
              </div>
