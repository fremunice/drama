...
export default function DramaNovaDetailPage() {
  ...
  const { data: drama, isLoading, error } = useDramaNovaDetail(bookId || "");
  ...
  const firstEpisodeId = firstEpisode?.number || firstEpisode?.id || "1";
            ...
            <div className="relative group">
              ...
              {firstEpisodeId && (
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-t from-background/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-6">
                  <Link
                    href={`/watch/dramanova/${bookId}/${firstEpisodeId}`}
            ...
            <div className="space-y-6">
              ...
              <div className="glass rounded-xl p-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  {drama.synopsis || drama.description || "Tidak ada deskripsi."}
                </p>
              </div>
