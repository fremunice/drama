...
import type { ReelShortBook, ReelShortBanner, ReelShortTabItem } from "@/types/reelshort";
...
export function ReelShortHome() {
  ...
  const { banners, books } = useMemo(() => {
    ...
    const popularTab = tabs.find((t: ReelShortTabItem) => t.tab_name === "POPULER") || tabs[0];
