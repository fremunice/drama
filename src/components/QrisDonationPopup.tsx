      ...
      <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden flex flex-col items-center p-6 border border-zinc-200 dark:border-zinc-800 animate-in zoom-in-95 duration-500">
        ...
        <div className="text-center space-y-2 mb-6">
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-400 font-medium leading-relaxed">
            Donasi kamu sangat berarti untuk menambah platform drama lain dan membayar tagihan bulanan <b>https://drama.sansekai.my.id (DRAMASHORT)</b> agar tetap aktif.
          </p>
        </div>
        ...
        <div className="mt-8 w-full">
          <button
            ...
            className={`w-full py-3 px-4 rounded-xl font-bold transition-all duration-300 flex items-center justify-center gap-2 ${countdown > 0
