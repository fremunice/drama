...
export type Platform = "pinedrama" | "dramabox" | "reelshort" | "shortmax" | "netshort" | "melolo" | "freereels" | "dramanova" | "goodshort"
  | "dramawave" | "flickreels" | "idrama" | "starshort" | "dramabite" | "moboreels" | "flareflow";
...
export const PLATFORMS: PlatformInfo[] = [
  ...
  },
  {
    ...
    name: "StarShort",
    logo: "/starshort.png",
    apiBase: "/api/starshort",
  },
  {
    id: "dramabite",
    name: "DramaBite",
    logo: "/dramabite.png",
    apiBase: "/api/dramabite",
  },
];
...
export function usePlatform() {
  ...
  return {
    ...
    isIdrama: currentPlatform === "idrama",
    isStarShort: currentPlatform === "starshort",
    isDramaBite: currentPlatform === "dramabite",
    isMoboReels: currentPlatform === "moboreels",
    isFlareFlow: currentPlatform === "flareflow",
  };
}
